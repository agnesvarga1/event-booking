    ...
    >
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    >
                        <div>
                            ...
                            >
                                Book events in different meeting rooms with
                                different needs and manage all of them at the
                                same place. Schedule view to know what is coming
                                up. Log in to know more...
                            </p>
                        </div>
                    ...
                    >
                        <div>
                            ...
                            <p
                                class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed"
                            >
                                Manage all meeting rooms at the same place,
                                different event demands different event room.
            ...
            >
                ...
                >
                    <!-- Laravel v{{ laravelVersion }} (PHP v{{ phpVersion }}) Code -->
                    Coded by AV 2024
                </div>
            </div>
        </div>
